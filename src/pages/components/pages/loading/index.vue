  ...
  <view class="pi-scroll-container">
    ...
    <scroll-view class="pi-scroll" scroll-y>
      <pi-card padding="0">
        ...
        <template slot="body">
          <view class="pi-justify-around pi-pd-24 ">
            <pi-loading show>示例1</pi-loading>
            <pi-loading show vertical>示例2</pi-loading>
          </view>
        </template>
      </pi-card>

      <pi-card padding="0">
        <pi-section slot="title" padding="24" title="图标类型" />
        <template slot="body">
          <view class="pi-justify-around pi-pd-24 ">
      ...
      <pi-card padding="0">
        <pi-section slot="title" padding="24" title="图标样式" />
        <template slot="body">
          <view class="pi-justify-around pi-pd-24  pi-align-center">
      ...
      <pi-card padding="0">
        <pi-section slot="title" padding="24" title="文字样式" />
        <template slot="body">
          <view class="pi-justify-around pi-pd-24  pi-align-center">
