<template>
  <view class="pi-scroll-container">
    ...
    <scroll-view class="pi-scroll" scroll-y>
      ...
      <!-- 顶部操作栏 -->
      <pi-card>
        <pi-section slot="title" padding="0" title="顶部操作栏" />
        <template slot="body">
      ...
      <!-- 显示标题 -->
      <pi-card>
        <pi-section slot="title" padding="0" title="显示标题" />
        <template slot="body">
      ...
      <!-- 显示取消按钮 -->
      <pi-card>
        <pi-section slot="title" padding="0" title="显示取消按钮" />
        <template slot="body">
      ...
      <!-- 自定义底部按钮 -->
      <pi-card>
        <pi-section slot="title" padding="0" title="自定义底部按钮" />
        <template slot="body">
